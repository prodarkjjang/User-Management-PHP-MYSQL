...
if(isset($_POST['submit']))
  {
    ...
    if ($idedit != '') {
        $sql="UPDATE blacklistusers SET name=(:name), email=(:email), platform=(:platform), username=(:username), description=(:description), phoneNo=(:phoneNo) WHERE id=(:idedit)";
    } else {
        $sql="INSERT INTO blacklistusers (name, email, platform, username, description, phoneNo) VALUES ((:name), (:email), (:platform), (:username), (:description), (:phoneNo))";
    }
  ...
  if ($idedit != '') {
      ...
      $query->execute();
      $msg="New Blacklist User Added Successfully";
  }
...
<head>
	...
	<title>Edit Blacklist User</title>
...
<body>
<?php
		$sql = "SELECT * from blacklistusers where id = :editid";
		$query = $dbh -> prepare($sql);
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Edit Blacklist User : <?php echo htmlentities($result->name); ?></h3>
						<div class="row">
							<div class="col-md-12">
...
<form method="post" class="form-horizontal" enctype="multipart/form-data" name="imgform">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">Platform<span style="color:red">*</span></label>
        <div class="col-sm-4">
            <input type="text" name="platform" class="form-control" required value="<?php echo htmlentities($result->platform);?>">
        </div>
        <label class="col-sm-2 control-label">Username<span style="color:red">*</span></label>
        <div class="col-sm-4">
            <input type="text" name="username" class="form-control" required value="<?php echo htmlentities($result->username);?>">
        </div>
    </div>
