                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="edit-events.php">Create new event</a>
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($result->startDateTime); ?></td>
                                                        <td><?php echo htmlentities($result->endDateTime); ?></td>
                                                        <td><?php echo htmlentities($result->registerCount); ?></td>
                                                        <td><?php echo htmlentities($result->winnerCount); ?></td>
                                                        <td>
