                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($result->status == 1) { ?>
                                                                <a href="blacklist.php?confirm=<?php echo htmlentities($result->id); ?>">Active <i class="fa fa-check-circle"></i></a>
                                                            <?php } else { ?>
                                                                <a href="blacklist.php?unconfirm=<?php echo htmlentities($result->id); ?>">Inactive <i class="fa fa-times-circle"></i></a>
                                                            <?php } ?>
                                                        </td>
                                                        <td>
                                                            <a href="edit-blacklist.php?edit=<?php echo $result->id; ?>">&nbsp; <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
